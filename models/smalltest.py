...
parser.add_argument('--save_model_path', type=str, default='saved_models/enthusiasm_model_fast.pt',
                    help='Path to save the trained model')
parser.add_argument('--num_epochs', type=int, default=1, help='Number of training epochs')
parser.add_argument('--batch_size', type=int, default=8, help='Batch size for training')
parser.add_argument('--subset_size', type=int, default=2000, help='Number of samples to use for testing')
...
enthusiastic_labels = [3, 7, 11]  # joy, excitement, love
...
texts = dataset['train']['text'][:args.subset_size]
labels = [map_labels(l) for l in dataset['train']['labels'][:args.subset_size]]
